...
let fruta1 = "MORANGO"
let fruta01 = fruta1.toLowerCase()
console.log (fruta01)
...
let animal01 = animal1.toUpperCase()
...
let fruta3 = "abacaxi"
let fruta03 = fruta3.replaceAll("a", "o")
console.log(fruta03)
...
let fruta5 = "melancia"
let fruta05 = fruta5.replaceAll("i","a")
console.log(fruta05)
...
let animais = ["cachorro", "golfinho do arrawady", "leão"]
console.log(animais.filter(animais => animais !== "leão"))
...
console.log(frutas4)
// 18. Crie um array 
let objetos = ["objeto1", "objeto2", "objeto4"]
console.log(objetos)
